...
param_space = {'n_neighbors': hp.choice('n_neighbors', range(1,300)),
...
def run_trials():
    ...
    #Optimize
    best = fmin(fn=knn_objective, space=param_space, algo=tpe.suggest, max_evals=max_trials, trials=trials, rstate = rand_state)
...
def get_results(trials, X_train, y_train):
    ...
    def compute_cv_metric(split, cross_val_data, bayes_trials_results):
        ...
        clf = KNeighborsClassifier(**bayes_trials_results[0]['params'])
