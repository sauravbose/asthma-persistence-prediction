...
def xgb_objective(params):
    clf = XGBClassifier(**params, n_jobs=-1, random_state = 0)
    ...
    def compute_cv_metric(split, cross_val_data):
        ...
        # clf.fit(train_x,train_y, eval_set=eval_set, eval_metric="average_precision",
...
def get_results(trials, X_train, y_train):
    ...
    def compute_cv_metric(split, cross_val_data, bayes_trials_results):
        ...
        clf = XGBClassifier(random_state=0, n_jobs=-1,**bayes_trials_results[0]['params'])
